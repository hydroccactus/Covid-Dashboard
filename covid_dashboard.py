...
def load_data():
    try:
        ...
        usa_data = pd.read_csv(os.path.join(DATA_DIR, "full_grouped.csv"))  # Replace usa_county_wise.csv with full_grouped.csv
...
if page == "Project Overview":
    ...
    **Team Members:**
    ...
    for name, df in zip(["Country Data", "Time-Series Data", "Daywise Data", "Full Grouped Data"],
